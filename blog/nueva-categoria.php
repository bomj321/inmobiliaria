<div id="nueva-categoria" uk-modal>
    <div class="uk-modal-dialog uk-margin-auto-vertical">
        <button class="uk-modal-close-default" type="button" uk-close></button>
        <div class="uk-modal-header">
			<div class="uk-grid">
				<div class="uk-width-1-1">
			<h5 class="uk-modal-title "><span uk-icon="icon:tag;ratio:1;" class="icon-margin"></span> Creación de nueva categoría blog</h5>
				</div>
		...
		<div class="uk-width-1-2" style="margin-top:10px">
            ...
            <label style="cursor:pointer"><input class="uk-checkbox" type="checkbox" checked>&nbsp; ¿Activar categoría?</label>
