...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
			...
			<a href="<?php echo DIR;?>clientes/addclientes?tipocliente=sale">
...
<?php
$stmt = $db->prepare("SELECT ID ,clientType, dateAdded, clientName, clientEmail,clientTel1  FROM clients WHERE clientType = 'sale' ORDER BY ID DESC limit 400");
...
<tr>
										...
										<td>
											<div class="uk-grid uk-grid-small">
												...
												<a style='color: black;' href="<?php echo DIR;?>clientes/editarcliente.php?idcliente=<?php echo $row['ID']?>&tipocliente=sale"><span uk-icon="icon:pencil;ratio:1" uk-tooltip="Editar"></span></a>
