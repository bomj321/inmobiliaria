...
<div class="form-inline form-group">
	 ...
	 <div class="form-group">
	  	    <input style='margin-right: 3rem;' type="text" class="form-control" id="a_que_precio_1<?php echo $id ?>" placeholder="Precio" name="a_que_precio_1<?php echo $id ?>">
	  	    <select class="form-control" id="a_que_precio_2<?php echo $id ?>" required="true" name="a_que_precio_2<?php echo $id ?>">
