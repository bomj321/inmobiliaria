...
<div class="panel panel-default">
				...
				<div class="panel-body">
				    	<div class="form-group">
					    	<label for="cuando_se_paganot">¿Cuándo se paga?</label>
						    <select class="form-control" id="cuando_se_paganot<?php echo $id ?>" required="true" name="cuando_se_paganot<?php echo $id ?>">
