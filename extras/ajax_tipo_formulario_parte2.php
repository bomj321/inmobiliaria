...
<!--RESPUESTA AJAX-->
 				<div id='precio_formulario_parte_1'></div>
<!--RESPUESTA AJAX-->
...
<!--RESPUESTA AJAX-->
 				<div id='precio_formulario_parte_2'></div>
<!--RESPUESTA AJAX-->
				...
				<div class="form-inline">
					   <label style="margin-right: 50px;">¿En qué día se aplica?</label>
				    	 ...
				    	 <label class="radio-inline">
						  <input type="radio" name="que_dia_aplica" id="inlineRadio1" value="0"> En la fecha de entrada
						</label>


						<label class="radio-inline">
						  <input type="radio" name="que_dia_aplica" id="inlineRadio2" value="1"> En la fecha de salida
						</label>
