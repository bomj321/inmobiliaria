...
<div class="panel panel-default">
		...
		<div class="panel-body">
		    	 <div class="form-group">
	   				 <label for="precio_incluidonot">¿Está incluido en el precio?</label>
				     <select onchange="precio_formulario_ajax_add_not(<?php echo $id ?>)" class="form-control" id="precio_incluidonot<?php echo $id ?>" required="true" name="precio_incluidonot<?php echo $id ?>">
					      <option value="1">Si</option>
					      <option value="0">No</option>			    
				     </select>
 				</div>
<!--RESPUESTA AJAX-->
 				<div id='precio_formulario_parte_1_not<?php echo $id ?>'></div>
<!--RESPUESTA AJAX-->

 				<div class="form-group">
	   				 <label for="ivanot">IVA aplicado</label>
				     <select class="form-control" id="ivanot<?php echo $id ?>" required="true" name="ivanot<?php echo $id ?>">
...
<!--RESPUESTA AJAX-->
 				<div id='precio_formulario_parte_2_not<?php echo $id ?>'></div>
<!--RESPUESTA AJAX-->
				...
				<div class="form-inline">
					   <label style="margin-right: 50px;">¿En qué día se aplica?</label>
				    	 ...
				    	 <label class="radio-inline">
						  <input type="radio" name="que_dia_aplicanot<?php echo $id ?>" id="inlineRadio1not" value="0"> En la fecha de entrada
						</label>


						<label class="radio-inline">
						  <input type="radio" name="que_dia_aplicanot<?php echo $id ?>" id="inlineRadio2not" value="1"> En la fecha de salida
						</label>
...
<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
	   				 <label for="proveedoresnot">Proveedor</label>
				     <select class="form-control" id="proveedoresnot<?php echo $id ?>" required="true" name="proveedoresnot<?php echo $id ?>">
