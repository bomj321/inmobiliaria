<script type="text/javascript">
            ...
            $("#multiFiles").change(function(){
                    ...
                    $.ajax({
                        url: '<?php echo DIR;?>blog/uploads-servicios.php', 
                        dataType: 'text', 
                        cache: false,
                        contentType: false,
                        processData: false,
...
<div id="galeria-listado" class="uk-modal-container" uk-modal="stack:true;" style="z-index:100000">
    <div class="uk-modal-dialog uk-margin-auto-vertical">
        ...
        <div class="uk-modal-header">
			...
			<h5 class="uk-modal-title "><span uk-icon="icon:image;ratio:1.2;" class="icon-margin"></span> Editar galería de imagenes del servicio: <strong class="yellow"></strong></h5>
				</div>
