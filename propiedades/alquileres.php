...
<!--------------------------------------TABS-->
			<div style="margin-top: 0px;">
			  <ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a style='color: black;' href="alquileres.php" aria-controls="activadas" role="tab" data-toggle="tab">Activadas/Short</a></li>
					...
					<a href="<?php echo DIR;?>propiedades/propiedad?action=alquiler">
						<button  class="uk-button button-direct " style="background-color:#F9B233;color:#fff"><span uk-icon="icon:plus;"></span> Añadir propiedad</button>	</a> &nbsp;&nbsp; <b>Estás en: Alquileres > Vacacionales (Activos-Short)</b>
...
function verperiodos($id) {
	...
	$.ajax({
        url: '<?php echo DIR;?>propiedades/senciyaPeriodos.php?idrental=' + id, // url where to submit the request
        beforeSend: function(){
		  	$(".loader").show();
		},
...
function vercalendario($id) {
	...
	$.ajax({
        url: '<?php echo DIR;?>propiedades/senciyaCalendar.php?idrental=' + id, // url where to submit the request
        beforeSend: function(){
		  	$(".loader").show();
		},
        success : function(result) {
