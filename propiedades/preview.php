...
$ref=$_POST["ref"];
$divid= $_POST['divid'];
$zonas = $db->prepare("SELECT `ID`, `yourRef`, `active`, `propTown`, `propLocation`, `SellerID`, `photoOrder`, `propStatus`, `propFeatured`, `propCondition`, `propNameES`, `propNameEN`, `propNameDE`, `propNameFR`, `propAddress`, `propTownID`, `propArea`, `propLinkMap`, `propType`, `propYear`, `propHouseM2`, `propTerraceM2`, `propLandM2`, `propGarden`, `propViews`, `propAccess`, `propBedDouble`, `propBedSingle`, `propBathroom`, `propBathEnSuite`, `propToilet`, `propLift`, `propKitchen`, `propLounge`, `propOffice`, `propLaundry`, `propFire`, `PropPool`, `propGuest`, `propParking`, `propAirCon`, `propHeating`, `propWater`, `propFurnish`, `propElectricity`, `propDrain`, `propSecurity`, `propCellar`, `propInterest`, `propBusUnits`, `propBusStorage`, `propBusBath`, `propBusSound`, `propBusDJ`, `propBusGames`, `propBusPC`, `propBusTill`, `propBusSatTV`, `propBusTVs`, `propBusFans`, `propBusLocation`, `propBusFridge`, `propBusAccomm`, `propBusTerraceCov`, `propBusTel`, `propBusInternet`, `propBusLicenses`, `propBusStock`, `propBusAllYear`, `propBusLease`, `propBusRental`, `propBusRentP`, `propKeysOffice`, `propSizeOffice`, `propPrice`, `propComm`, `propBoard`, `propMarketDate`, `propDescripEN`, `propDescripES`, `propDescripDE`, `propDescripFR`, `propNotesPublic`, `propNotesPrivate`, `propViewedBy`, `propPictures`, `propPortals`, `propOrigin`,`esLujo`, `titleEs`, `titleEn`, `titleDe`, `clasifEnergia`, `consumEnergia`, `viewTarget`, `dateAdded`, `dateModified`, `views`, `propPOA`, `OfficeID`, `EmployeeID`, `propProvince`, `propCountry` FROM properties where ID='$ref'");
...
$stmt4 = $db->prepare("SELECT full FROM image_properties WHERE ref='$ref' and orden=1");//////////////////////////////REVISAR ESTA PARTE DEL CODIGO
$stmt4->execute();
...
<div id="previewajax" class="uk-modal-full" uk-modal>
    <div class="uk-modal-dialog">
		...
		<div class="uk-text-right"><a href="<?php echo DIR;?>propiedades/editar?idventa=<?php echo $row3['ID']?>" class="uk-button button-direct"><span uk-icon="icon:pencil; ratio:0.9" class="icon-margin"></span> Editar propiedad</a></div>
		<div class=" uk-text-right"><button onclick="previewGallery('<?php echo $row3['ID']?>','<?php echo $divid ?>')" class="uk-button button-direct"><span uk-icon="icon:image; ratio:0.9" class="icon-margin"></span> Editar galería</button></div>		
	</div>
					</div>
				</div>
