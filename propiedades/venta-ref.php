	...
	<div style="margin-top: 0px;">
		  <ul class="nav nav-tabs" role="tablist">
		    ...
		    <a href="<?php echo DIR;?>propiedades/propiedad" style='margin-left: 50px;'>
				<button  class="uk-button button-direct " style="background-color:#F9B233;color:#fff"><span uk-icon="icon:plus;"></span> Añadir propiedad</button></a>  &nbsp;&nbsp; <b>Estás en: Ventas > Buscar por referencia</b>
