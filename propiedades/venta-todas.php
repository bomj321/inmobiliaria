...
<?php
$stmt = $db->prepare("SELECT properties.yourRef,properties.propNameES,properties.ID,properties.active,properties.propType,properties.propLocation,properties.propTown,properties.propNameES,properties.propPrice FROM properties ORDER BY properties.yourRef desc limit 1500");
