    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
            <h5 style="background-color: #efefef; font-weight: 600; color: #8b8f91; padding: 10px 10px 10px 10px;">
                <a href="<?php echo DIR; ?>propietarios/addpropietarios">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="margin-top: 30px;">
            <table id="propietarios" class="table table-hover bulk_action dt-responsive nowrap table-striped"  cellspacing="0" width="100%">
                ...
                <tbody >
                    ...
                    <?php
                    $stmt = $db->prepare("SELECT ID,propType,dateAdded,sellerName1,sellerName2,sellerTel,sellerMob,sellerEmail FROM owners  ORDER BY ID DESC LIMIT 1600");
...
<script type="text/javascript">
    function previewModal(param) {
        $.ajax({
            type: "POST",
            url: "<?php echo DIR; ?>propietarios/previewreserva",
            data: param,
    ...
    function deletedata($id) {
        ...
        UIkit.modal.confirm('¿Confirma que desea eliminar el cliente?', {center: true, labels: {ok: 'Ok', cancel: 'Volver a Propietarios'}}).then(function () {
            ...
            $.ajax({
                url: '<?php echo DIR; ?>propietarios/deletepropietario?idpropietario=' + id, // url where to submit the request               
