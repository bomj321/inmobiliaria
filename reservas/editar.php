			...
			<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
						    ...
						    <select class="form-control" id="id_propiedad" required="true" name="id_propiedad">
						      <option value="">Seleccione</option>
						      <?php 	
						   $propiedades = $db->prepare("SELECT propTown,propType,propAddress,ID FROM rentals ORDER BY ID desc");
...
<div class="row">
	<div class="col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			    ...
			    <input value='<?php echo $row['dateAdded']?>' type="date" class="form-control" id="fecha_reserva" placeholder="Fecha de Salida" name="fecha_reserva">
 		   </div>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-12">
		 <div class="form-group">
...
<div class="row">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		  <div class="form-group">
			    ...
			    <input value='<?php echo $row['bookingChildren']?>' type="text" class="form-control" id="age_childrens" placeholder="Ej: 12,13,14" name="age_childrens">
 		   </div>
	</div>
</div>
<!--QUINTA FILA-->
